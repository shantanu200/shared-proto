...
const (
	UserService_GetUserAddressById_FullMethodName = "/user.UserService/GetUserAddressById"
	UserService_GetUser_FullMethodName            = "/user.UserService/GetUser"
	UserService_UpdateOrderPlaced_FullMethodName  = "/user.UserService/UpdateOrderPlaced"
	UserService_GetUserTotalCount_FullMethodName  = "/user.UserService/GetUserTotalCount"
	UserService_GetActiveUserCount_FullMethodName = "/user.UserService/GetActiveUserCount"
)
...
func (c *userServiceClient) GetUserAddressById(ctx context.Context, in *AddressReq, opts ...grpc.CallOption) (*UserAddress, error) {
	...
	out := new(UserAddress)
	err := c.cc.Invoke(ctx, UserService_GetUserAddressById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) UpdateOrderPlaced(ctx context.Context, in *UserReq, opts ...grpc.CallOption) (*EmptyReq, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmptyReq)
	err := c.cc.Invoke(ctx, UserService_UpdateOrderPlaced_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetUserTotalCount(ctx context.Context, in *DateRangeRequest, opts ...grpc.CallOption) (*UserTotalCount, error) {
	...
	err := c.cc.Invoke(ctx, UserService_GetUserTotalCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetActiveUserCount(ctx context.Context, in *DateRangeRequest, opts ...grpc.CallOption) (*ActiveUserTotalCount, error) {
	...
	err := c.cc.Invoke(ctx, UserService_GetActiveUserCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_GetUserAddressById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetUserAddressById_FullMethodName,
	}
...
func _UserService_UpdateOrderPlaced_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_UpdateOrderPlaced_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_GetUserTotalCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetUserTotalCount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_GetActiveUserCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetActiveUserCount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
